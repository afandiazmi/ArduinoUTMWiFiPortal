// // This example demonstrates a simple usage of the UTMWiFiPortal library to connect
...
#include <WiFi.h>
#include <UTMWiFiPortal.h> // Include the library header
...
UTMWiFiPortal portal(PORTAL_USER, PORTAL_PASS);
